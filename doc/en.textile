...
Note : If your server and your browser both support SSE (Server-Sent Events), you don't need to set the "Refresh feeds every..." setting, because your feeds will update automatically in your browser when the worker script runs.
