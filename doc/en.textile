...
* *Cleanup* : Deletes old items in the local database. Only read items are deleted. You can specify the age limit for items in days. All items older than this limit will be deleted when clicking the "Cleanup" button.
