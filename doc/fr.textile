...
* *Rafraîchir avec des SSE* : Si votre serveur et votre navigateur supportent les SSE (Server-Sent Events) et que cette préférence est activée, les données dans le navigateur seront rafraichis automatiquement à chaque synchronisation des abonnements.
