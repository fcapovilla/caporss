...
* */* : Effectuer une recherche d'items
* *A* : Afficher la fenêtre d'abonnement
* *R* : Synchroniser tous les abonnements
...
* *Nettoyage* : Supprime les vieux items dans la base de données locale. Vous pouvez spécifier une limite d'âge en jours. Seul les items dont la date dépasse cette limite seront supprimés lors d'un clic sur le bouton "Nettoyage".
...
h1. Syncroniser les abonnements périodiquement
...
Note : Si votre serveur et votre navigateur supportent les SSE (Server-Sent Events), vous n'avez pas besoin de configurer la préférence "Rafraîchir toutes les...", car vos abonnements seront mis à jour automatiquement dans votre navigateur à chaque fois que le script "worker" est éxécuté.
